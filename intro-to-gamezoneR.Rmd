...
```{r}
pbp <- gamezoneR::game_zone_cbb_pbp(duke_schedule$game_id[2],
                                    sub_parse = T)
...
```{r}
duke_pbp <- purrr::map_df(duke_schedule$game_id, game_zone_cbb_pbp, sub_parse = F)
```
...
gamezoneR::base_court +
  ...
  labs(title = "All of Zion Williamson's shots",
