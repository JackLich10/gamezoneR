...
Let's take a look at the most proficient offenses in college basketball since 2014-15
...
pbp_summarized %>%
  ...
  gt::tab_header(title = gt::md("**Best team offensive efficiencies**"),
                 subtitle = gt::md("*2014-15 through 2020-21 college basketball seasons*")) %>%
